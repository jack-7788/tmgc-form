  ...
  <a-layout class="main-container full-height">
    <a-layout-header class="main-header">
      ...
      <div class="float-right external-link">
        <a-select v-if="showLink('languageMenu')" style="width:150px" v-model:value="curLangName"
    ...
    <a-layout>
      ...
      <a-layout-content class="center-layout-container">
        ...
        <a-layout-content class="form-widget-main">
          <div class="container-scroll-bar" :style="{ height: scrollerHeight }">
...
.ant-layout.center-layout-container {
  min-width: 680px;
